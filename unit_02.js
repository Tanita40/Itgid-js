...
function t11() {
let data = input11.value;
out11.innerHTML = data+55;
}
...
let input12_1 = document.querySelector('.i-12-1');
let input12_2 = document.querySelector('.i-12-2');
let out12 = document.querySelector('.out-12');

function t12() {
let data = input12_1.value + ' ' + input12_2.value;
out12.innerHTML = 'Hello' + ' ' + data;
}
...
function t14() {
    let data = input14.value;
    input14.innerHTML = data;
    input14.value = 'Go';
...
function t15() {
    let data = input15.value;
    input15.innerHTML = data;
    input15.value = 'style.border = "4px solid red"'
}
...
function t16() {
    let sum  = input16_1.value + input16_2.value;
    out16.innerHTML = sum;
}
...
function t19() {
    let sum = input19_1.value + input19_2.value;
     out19.innerHTML =  +sum;
