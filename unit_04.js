...
function f6() {
    let myInput = document.querySelector('.i-6')
        document.querySelector('.out-6').innerHTML = myInput.value;
...
function f8() {
    ...
    div.innerHTML = '<div class = js2>new div</div>';
}
