...
let ar2 = ['Viktor', 40, true, ] // переменную обьявляем здесь!!!!
...
let ar3 = [55, 44, 33, 22, 11, 1] // переменную обьявляем здесь!!!!
...
let ar4 = [1, 2, 3, 4, 5, 6, 7, 8, 9] // переменную обьявляем эту здесь!!!!
...
function f8() {
    ...
    document.querySelector('.out-8-1').innerHTML = length;
}
